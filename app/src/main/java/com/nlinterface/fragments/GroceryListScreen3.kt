...
class GroceryListScreen3 : Fragment(), SwipeAction {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.grocerylist_screen3, container, false)
    ...
    override fun onSwipeLeft() {
        findNavController().navigate(R.id.GroceryList3_to_GroceryList4)
    }

    override fun onSwipeRight() {
        findNavController().navigate(R.id.GroceryList3_to_GroceryList2)
    }
