...
class PlaceDetailsScreen3: Fragment(), SwipeAction {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.place_details_screen3, container, false)
    ...
    override fun onSwipeLeft() {
        findNavController().navigate(R.id.PlaceDetails3_to_PlaceDetails2)
    }
    ...
    override fun onSwipeUp() {
        findNavController().navigate(R.id.PlaceDetails3_to_PlaceOptions)
    }
